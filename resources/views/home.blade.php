...
<body class="bg-slate-50 text-slade-800 min-h-screen flex flex-col">
    <header class="bg-white shadow-sm">
        <div class="max-w-7xl mx-auto flex justify-between py-3 items-center">
            <div>
                <img src="img/logo-light.svg" alt="Portal Notícias">
            </div>
            <nav>
    ...
    <main class="flex-1 max-w-7xl mx-auto my-10">
        <div>
            ...
            <p class="text-sm text-slade-600">Fique por dentro dos acontecimentos mais importantes do Brasil e do mundo,
                com notícias atualizadas em tempo real.</p>
        </div>
        <div class="flex gap-3 mt-6 mb-6">
            <a href="#" class="bg-[#4040fd] text-white px-3 py-0.5 rounded-full">Todas</a>
            <a href="#" class="bg-[#4910a7] text-white px-3 py-0.5 rounded-full">Tecnologia</a>
            <a href="#" class="bg-[#fd9e40] text-white px-3 py-0.5 rounded-full">Educação</a>
            <a href="#" class="bg-[#4088fd] text-white px-3 py-0.5 rounded-full">Negócio</a>
        </div>
            ...
            @for ($i = 0; $i < 3; $i++)
                <article class="bg-white rounded-lg overflow-hidden shadow-sm">
                    ...
                    <div class="overflow-Hidden h-50">
                        <img src="https://placehold.co/600x300" alt="Foto Capa" class="w-full h-full object-cover ">
                    </div>

                    <div class="p-3">
                        <span class="bg-[#4910a7] text-white px-3 py-0.5 rounded-full">Tecnologia</span>

                        <h3 class="font-bold text-lg mt-3">PHP continua dominando o desenvolvimento web</h3>

                        <p class="text-sm ">Descubra por que PHP segue sendo a linguagem mais utilizada para
                            desenvolvimento
                            web em 2026</p>
    ...
    <footer class="bg-slate-900 text-white">
        <div class="max-w-7xl mx-auto py-4">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <div class="flex gap-2.5">
                        <span class="bg-slate-800 text-slate-600 rounded-md px-3 py-1.5">PHP 8</span>
                        <span class="bg-slate-800 text-slate-600 rounded-md px-3 py-1.5">SQL</span>
                        <span class="bg-slate-800 text-slate-600 rounded-md px-3 py-1.5">Laravel</span>
                        <span class="bg-slate-800 text-slate-600 rounded-md px-3 py-1.5">C#</span>
                    </div>
                </div>
            ...
            <div class="border-t border-slate-500 text-center p-2 mt-5">
                &copy; Todos os direitos são reservados
            </div>
        </div>
    </footer>
</body>
